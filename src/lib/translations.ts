...
export const translations = {
  en: {
    ...
    'hero.description': 'The First. The Fastest. The Only. NetLync Entitlements-as-a-Service platform with GSMA SGP.22 v4.0 compliance and enterprise-grade security.',
    'hero.cta.primary': 'Check Device Compatibility',
    'hero.cta.secondary': 'Access Dashboard',
    'nav.home': 'Home',
    'nav.about': 'About',
    'nav.partners': 'Partners',
    'nav.dashboard': 'Dashboard',
    'nav.contact': 'Contact',
    'footer.company': 'ESIM MYANMAR COMPANY LIMITED',
    'footer.powered': 'Powered by NetLync EaaS Platform',
    'footer.compliance': 'GSMA SGP.22 v4.0 Compliant | Myanmar ETL 2021 | GDPR | PDPA',
  ...
  my: {
    ...
    'hero.subtitle': 'Entitlements-as-a-Service',
    'hero.description': 'ပထမဆုံး။ အမြန်ဆုံး။ တစ်ခုတည်း။ GSMA SGP.22 v4.0 နှင့် NetLync Entitlements-as-a-Service ပလပ်ဖောင်း၊ လုံခြုံရေး အဆင့်မြင့်။',
    'hero.cta.primary': 'စက်ပစ္စည်း လိုက်ဖက်မှု စစ်ဆေးရန်',
    'hero.cta.secondary': 'ဒက်ရှ်ဘုတ် ဝင်ရောက်ရန်',
    ...
    'footer.company': 'ESIM MYANMAR COMPANY LIMITED',
    'footer.powered': 'NetLync EaaS ပလပ်ဖောင်းဖြင့် ပံ့ပိုးထားသည်',
    'footer.compliance': 'GSMA SGP.22 v4.0 လိုက်နာမှု | မြန်မာ ETL 2021 | GDPR | PDPA',
