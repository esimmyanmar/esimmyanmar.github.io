...
export default function Sitemap() {
  return (
    <>
      <Head>
        <title>Sitemap | eSIM Myanmar</title>
        <meta name="description" content="eSIM Myanmar Sitemap - Premium connectivity solutions with Microsoft technology" />
      </Head>
          ...
          <main className="container mx-auto px-6 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="glass-card p-8">
                <p className="text-xl text-slate-300 mb-6">eSIM Myanmar Sitemap - Premium connectivity solutions with Microsoft technology</p>
