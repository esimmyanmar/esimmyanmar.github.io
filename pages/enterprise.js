...
export default function Enterprise() {
  return (
    <>
      <Head>
        <title>Enterprise | eSIM Myanmar</title>
        <meta name="description" content="eSIM Myanmar Enterprise - Premium connectivity solutions with Microsoft technology" />
      </Head>
        ...
        <div className="glass-container">
          ...
          <main className="container mx-auto px-6 py-16">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-5xl font-bold text-white mb-8">Enterprise</h1>
              <div className="glass-card p-8">
                <p className="text-xl text-slate-300 mb-6">eSIM Myanmar Enterprise - Premium connectivity solutions with Microsoft technology</p>
