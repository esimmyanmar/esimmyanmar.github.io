...
export default function Education() {
  return (
    <>
      <Head>
        <title>Education | eSIM Myanmar</title>
        <meta name="description" content="Premium eSIM community services - Education with Microsoft technology stack and global coverage" />
      </Head>
          ...
          <main className="container mx-auto px-6 py-16">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="glass-card p-8">
                <p className="text-xl text-slate-300 mb-6">Premium eSIM community services - Education with Microsoft technology stack and global coverage</p>
