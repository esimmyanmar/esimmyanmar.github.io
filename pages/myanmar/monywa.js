...
export default function Monywa() {
  return (
    <>
      <Head>
        <title>Monywa | eSIM Myanmar</title>
        <meta name="description" content="Premium eSIM myanmar services - Monywa with Microsoft technology stack and global coverage" />
      </Head>
        ...
        <div className="glass-container">
          ...
          <main className="container mx-auto px-6 py-16">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-5xl font-bold text-white mb-8">Monywa</h1>
              <div className="glass-card p-8">
                <p className="text-xl text-slate-300 mb-6">Premium eSIM myanmar services - Monywa with Microsoft technology stack and global coverage</p>
