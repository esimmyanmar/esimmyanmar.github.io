...
export default function TechnologyPartnershipsPage() {
  return (
    <>
      <Head>
        <title>Technology Partnerships | eSIM Myanmar</title>
        <meta name="description" content="eSIM Myanmar Technology Partnerships - Premium connectivity solutions with Microsoft technology stack serving 50+ million users across ASEAN" />
        ...
        <div className="glass-container">
          <header className="premium-header">
            <div className="container mx-auto px-6 py-8">
              <div className="flex items-center justify-between">
                ...
                <div className="text-slate-400">technology-partnerships</div>
              </div>
            </div>
          </header>
          ...
          <main className="container mx-auto px-6 py-16">
            <div className="max-w-6xl mx-auto">
              <h1 className="text-6xl font-bold text-white mb-8">Technology Partnerships</h1>
              
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                  <div className="glass-card p-8 mb-8">
                    <p className="text-xl text-slate-300 mb-6">eSIM Myanmar Technology Partnerships - Premium connectivity solutions with Microsoft technology stack serving 50+ million users across ASEAN</p>
